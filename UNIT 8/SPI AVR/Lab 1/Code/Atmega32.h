...
typedef struct
{
	volatile uint8_t SPCR_r;
	volatile uint8_t SPSR_r;
	volatile uint8_t SPDR_r;	
...
//USART
#define USART_IRQ_RXC 14
#define USART_IRQ_UDRE 15
#define USART_IRQ_TXC 16

//SPI
#define SPI_IRQ_STC 13
