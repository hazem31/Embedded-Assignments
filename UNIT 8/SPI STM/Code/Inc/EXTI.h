...
typedef struct
{
	EXTI_GPIO_Mapping_t EXTI_PIN ; // specifies the external interrupt GPIO mapping , @ref EXTI_define

	uint8_t Trigger_Case; // specifies rising or falling or both , @ref EXTI_Trigger

	uint8_t IRQ_EN;  // enable or disable EXTI ( in mask register and in NNIC) , @ref EXTI_IRQ
...
//EXTI0
 ...
 #define EXTI0PE0        (EXTI_GPIO_Mapping_t){EXTI0 , GPIOE , GPIO_PIN_0 , EXTI0_IRQ}
...
//EXTI1
 ...
 #define EXTI1PE1        (EXTI_GPIO_Mapping_t){EXTI1 , GPIOE , GPIO_PIN_1 , EXTI1_IRQ}
...
//EXTI2
 ...
 #define EXTI2PE2        (EXTI_GPIO_Mapping_t){EXTI2 , GPIOE , GPIO_PIN_2 , EXTI2_IRQ}
...
//EXTI3
 ...
 #define EXTI3PE3        (EXTI_GPIO_Mapping_t){EXTI3 , GPIOE , GPIO_PIN_3 , EXTI3_IRQ}
...
//EXTI4
 ...
 #define EXTI4PE4        (EXTI_GPIO_Mapping_t){EXTI4 , GPIOE , GPIO_PIN_4 , EXTI4_IRQ}
...
//EXTI5
 ...
 #define EXTI5PE5        (EXTI_GPIO_Mapping_t){EXTI5 , GPIOE , GPIO_PIN_5 , EXTI5_IRQ}
...
//EXTI6
 ...
 #define EXTI6PE6        (EXTI_GPIO_Mapping_t){EXTI6 , GPIOE , GPIO_PIN_6 , EXTI6_IRQ}
...
//EXTI7
 ...
 #define EXTI7PE7        (EXTI_GPIO_Mapping_t){EXTI7 , GPIOE , GPIO_PIN_7 , EXTI7_IRQ}
...
//EXTI8
 ...
 #define EXTI8PE8        (EXTI_GPIO_Mapping_t){EXTI8 , GPIOE , GPIO_PIN_8 , EXTI8_IRQ}
...
//EXTI9
 ...
 #define EXTI9PE9        (EXTI_GPIO_Mapping_t){EXTI9 , GPIOE , GPIO_PIN_9 , EXTI9_IRQ}
...
//EXTI10
 ...
 #define EXTI10PE10        (EXTI_GPIO_Mapping_t){EXTI10 , GPIOE , GPIO_PIN_10 , EXTI10_IRQ}
...
//EXTI11
 ...
 #define EXTI11PE11        (EXTI_GPIO_Mapping_t){EXTI11 , GPIOE , GPIO_PIN_11 , EXTI11_IRQ}
...
//EXTI12
 ...
 #define EXTI12PE12        (EXTI_GPIO_Mapping_t){EXTI12 , GPIOE , GPIO_PIN_12 , EXTI12_IRQ}
...
//EXTI13
 ...
 #define EXTI13PE13        (EXTI_GPIO_Mapping_t){EXTI13 , GPIOE , GPIO_PIN_13 , EXTI13_IRQ}
...
//EXTI14
 ...
 #define EXTI14PE14        (EXTI_GPIO_Mapping_t){EXTI14 , GPIOE , GPIO_PIN_14 , EXTI14_IRQ}
...
//EXTI15
 ...
 #define EXTI15PE15        (EXTI_GPIO_Mapping_t){EXTI15 , GPIOE , GPIO_PIN_15 , EXTI15_IRQ}
